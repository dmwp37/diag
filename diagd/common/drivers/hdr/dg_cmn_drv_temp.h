...
enum
{
    ...
    DG_CMN_DRV_TEMP_FEB_2 = 0x04,
    DG_CMN_DRV_TEMP_CPU   = 0x05,
    DG_CMN_DRV_TEMP_PCH   = 0x06,
    DG_CMN_DRV_TEMP_PSU_0 = 0x07,
    DG_CMN_DRV_TEMP_PSU_1 = 0x08,
    DG_CMN_DRV_TEMP_WTB_1 = 0x09,
    DG_CMN_DRV_TEMP_WTB_2 = 0x0a,
    DG_CMN_DRV_TEMP_PHY_0 = 0x0b,
    DG_CMN_DRV_TEMP_PHY_1 = 0x0c,
    DG_CMN_DRV_TEMP_FPGA  = 0x0d,
};
