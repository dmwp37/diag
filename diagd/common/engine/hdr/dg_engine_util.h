...
==================================================================================================*/
/** Driver error string function pointer type */
typedef DG_CMN_DRV_ERR_T (*DG_ENGINE_UTIL_DRV_ERR_STRING_FUNC_T)(UINT32 max_length, char *err_str);
...
void DG_ENGINE_UTIL_rsp_set_error_string_drv(DG_DEFS_DIAG_RSP_BUILDER_T *rsp,
                                             DG_RSP_CODE_T code, 
                                             DG_ENGINE_UTIL_DRV_ERR_STRING_FUNC_T func_ptr,
                                             const char *format, ...);
