...
array_des[4]="Read I2C Bus=$BUS Address=$ADDRESS Offset=$RD_OFFSET Len=$RD_LEN"
array_des[5]="Write I2C Bus=$BUS Address=$ADDRESS Offset=$WR_OFFSET Len=$WR_LEN Data=$WR_DATA2"
array_des[6]="Read I2C Bus=$BUS Address=$ADDRESS Offset=$RD_OFFSET Len=$RD_LEN"
